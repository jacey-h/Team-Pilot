...
public:
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void structInMethod(const Ipc::IpcStruct &_structParameter, CommonAPI::CallStatus &_internalCallStatus, int32_t &_output, const CommonAPI::CallInfo *_info = nullptr);
    /**
...
template <typename ... _AttributeExtensions>
void IpcProxy<_AttributeExtensions...>::structInMethod(const Ipc::IpcStruct &_structParameter, CommonAPI::CallStatus &_internalCallStatus, int32_t &_output, const CommonAPI::CallInfo *_info) {
