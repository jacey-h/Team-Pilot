...
public:
     ...
     * will be set.
     */
    virtual void structInMethod(Ipc::IpcStruct _structParameter, CommonAPI::CallStatus &_internalCallStatus, int32_t &_output, const CommonAPI::CallInfo *_info = nullptr);
    /**
     ...
     */
    virtual std::future<CommonAPI::CallStatus> structInMethodAsync(const Ipc::IpcStruct &_structParameter, StructInMethodAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr);
...
template <typename ... _AttributeExtensions>
void IpcProxy<_AttributeExtensions...>::structInMethod(Ipc::IpcStruct _structParameter, CommonAPI::CallStatus &_internalCallStatus, int32_t &_output, const CommonAPI::CallInfo *_info) {
    delegate_->structInMethod(_structParameter, _internalCallStatus, _output, _info);
}

template <typename ... _AttributeExtensions>
std::future<CommonAPI::CallStatus> IpcProxy<_AttributeExtensions...>::structInMethodAsync(const Ipc::IpcStruct &_structParameter, StructInMethodAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
...
template <typename ... _AttributeExtensions>
std::future<void> IpcProxy<_AttributeExtensions...>::getCompletionFuture() {
